...
describe('Asset', () => {
  it('should wrap the js asset with comments', async () => {
    // Init bundler
    ...
    const expected = [
      expect.stringContaining('/* parcel-plugin-wrapper - 0.2.2 */'),
  ...
  it('should work with multiple entry points', async () => {
    // Init bundler
    ...
    expect(firstLine).toMatch('/* parcel-plugin-wrapper - 0.2.2 */')
